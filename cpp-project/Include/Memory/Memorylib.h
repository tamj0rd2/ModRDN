...
MMAPI void* MemCRTAlloc   ( size_t size, int type );
MMAPI void* MemCRTRealloc ( void* pointer, size_t newsize, int type );
MMAPI void	MemCRTFree	  ( void* pointer, int type );
MMAPI void*	MemStringAlloc( size_t size, size_t sizeOfOne );
MMAPI void	MemStringFree ( void* pointer );
