...
{
public:
	GameEvent_BuildUnitCommand(const RDNPlayer *p, const Entity *e, const ControllerBlueprint *pCBP) : GameEventSys::Event(GE_BuildUnitCommand, p),
...
{
public:
	GameEvent_BuildUnitStart(const RDNPlayer *p, const Entity *e, const ControllerBlueprint *pCBP) : GameEventSys::Event(GE_BuildUnitStart, p),
...
{
public:
	GameEvent_BuildUnitComplete(const RDNPlayer *p, const Entity *spawner, const Entity *e) : GameEventSys::Event(GE_BuildUnitComplete, p),
...
{
public:
	GameEvent_BuildUnitCancel(const RDNPlayer *p, const Entity *spawner, const ControllerBlueprint *pCBP) : GameEventSys::Event(GE_BuildUnitCancel, p),
...
{
public:
	GameEvent_BuildUnitBlocked(const RDNPlayer *p, const Entity *spawner) : GameEventSys::Event(GE_BuildUnitBlocked, p),
																																					m_pSpawner(spawner) {}
...
{
public:
	GameEvent_HenchmanEntityEntityCmd(const RDNPlayer *p, const Entity *e, const Entity *target) : GameEventSys::Event(GE_HenchmanEntityEntityCmd, p),
...
{
public:
	GameEvent_HenchmanEntityEntityCancel(const RDNPlayer *p, const EntityGroup &entities) : GameEventSys::Event(GE_HenchmanEntityEntityCancel, p),
																																													m_pERef(entities) {}
...
{
public:
	GameEvent_HenchmanEntityPointCmd(const RDNPlayer *p, const Entity *e) : GameEventSys::Event(GE_HenchmanEntityPointCmd, p),
																																					m_pEntity(e) {}
...
{
public:
	GameEvent_HenchmanEntityPointCancel(const RDNPlayer *p, const EntityGroup &entities) : GameEventSys::Event(GE_HenchmanEntityPointCancel, p),
																																												 m_pERef(entities) {}
...
{
public:
	GameEvent_HenchmanEntityCmd(const RDNPlayer *p, const Entity *e) : GameEventSys::Event(GE_HenchmanEntityCmd, p),
																																		 m_pEntity(e) {}
...
{
public:
	GameEvent_HenchmanCantReachBuilding(const RDNPlayer *p, const Entity *pHenchman, const Entity *pTarget) : GameEventSys::Event(GE_HenchmanCantReachBuilding, p),
...
{
public:
	GameEvent_UIHenchmanBuild() : GameEventSys::Event(GE_UIHenchmanBuild, 0) {}
};
...
{
public:
	GameEvent_UIStartBuildUnit(long ebpid) : GameEventSys::Event(GE_UIStartBuildUnit, 0), m_ebpid(ebpid) {}
...
{
public:
	GameEvent_UIObjectiveDlgShown() : GameEventSys::Event(GE_UIObjectiveDlgShown, 0) {}
};
...
{
public:
	GameEvent_GameStart() : GameEventSys::Event(GE_GameStart, 0) {}
};
...
{
public:
	GameEvent_GameOver() : GameEventSys::Event(GE_GameOver, 0) {}
};
...
public:
	...
	GameEvent_AttackBlocked(const RDNPlayer *p, const Entity *e, Blockage blockage) : GameEventSys::Event(GE_AttackBlocked, p),
																																										m_pEntity(e),
																																										m_blockage(blockage) {}
